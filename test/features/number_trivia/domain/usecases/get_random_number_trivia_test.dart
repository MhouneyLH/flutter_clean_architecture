...
import 'package:flutter_clean_code_example/features/number_trivia/domain/repositories/number_trivia_repository.dart';
...
void main() {
  ...
  test('should get trivia from the repository', () async {
    ...
    when(mockNumberTriviaRepository.getRandomNumberTrivia()).thenAnswer(
        (_) async => Right(tNumberTrivia)); // right = successful side
    // act
